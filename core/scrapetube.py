...
async def get_videos(
    url: str, api_endpoint: str, selector: str, limit: int = 1, sleep: int = 1, sort_by: Optional[str] = None
    ...
    try:
        ...
        while True:
            if is_first:
                ...
                next_data = get_next_data(data, sort_by) # type: ignore
                is_first = False
...
async def get_playlist(
    playlist_id: str, limit: int = 1, sleep: int = 1
) -> AsyncGenerator[dict, None]:
